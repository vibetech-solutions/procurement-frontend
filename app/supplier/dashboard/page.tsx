        ...
        <Grid gutter="lg">
          ...
          <Grid.Col span={{ base: 12, md: 4 }}>
            <Card shadow="sm" padding="lg" radius="md" withBorder>
              ...
              <Stack gap="sm">
                <Paper p="md" withBorder style={{ cursor: "pointer" }} component={Link} href="/supplier/catalogue">
                  <Group>
                    <IconEye size={20} />
                    <Text size="sm">Manage Catalogue</Text>
                  </Group>
                </Paper>
                <Paper p="md" withBorder style={{ cursor: "pointer" }} component={Link} href="/supplier/rfqs">
                  <Group>
                    <IconFileText size={20} />
                    <Text size="sm">View RFQs</Text>
                  </Group>
                </Paper>
                <Paper p="md" withBorder style={{ cursor: "pointer" }} component={Link} href="/supplier/quotations">
                  <Group>
                    <IconClipboardList size={20} />
                    <Text size="sm">Submit Quotations</Text>
                  </Group>
                </Paper>
                <Paper p="md" withBorder style={{ cursor: "pointer" }} component={Link} href="/supplier/orders">
                  <Group>
                    <IconTruck size={20} />
                    <Text size="sm">Track Orders</Text>
                  </Group>
                </Paper>
                <Paper p="md" withBorder style={{ cursor: "pointer" }} component={Link} href="/supplier/catalogue/new">
                  <Group>
                    <IconPlus size={20} />

...
const rfqData = {
  ...
  dueDate: "2025-01-25",
  description:
    "Server hardware and networking equipment for data center upgrade",
...
const quotations = [
  {
    ...
    items: [
      ...
      {
        name: "SRV-003 - Flight Booking Service",
        quantity: 1,
        unitPrice: 2000.0,
        total: 2000.0,
      },
  ...
  },
  {
    ...
    items: [
      {
        name: "HP Server DL380",
        quantity: 2,
        unitPrice: 5200.0,
        total: 10400.0,
      },
      { name: "Cisco Switch", quantity: 1, unitPrice: 2350.0, total: 2350.0 },
      {
        name: "SRV-004 - Hotel Accommodation",
        quantity: 1,
        unitPrice: 2000.0,
        total: 2000.0,
      },
                                    ...
                                    <Table.Td style={{ textAlign: "right" }}>
                                      <Text
                                        c={(() => {
                                          ...
                                          return item.unitPrice === minPrice
                                            ? "green"
                                            : item.unitPrice === maxPrice
                                            ? "red"
                                            : "dark";
                                        })()}
                                      >
      ...
      >
        <Tabs defaultValue="scores">
                ...
                <Table.Tbody>
                  {analysis.map((item, index) => (
                    <Table.Tr key={item.id}>
                      ...
                      <Table.Td>
                        <Text fw={600}>{item.overallScore}</Text>
                      </Table.Td>
                      <Table.Td>
          ...
          <Tabs.Panel value="items" pt="md">
            <Stack gap="md">
              <Text size="sm" c="dimmed">
                Select the best supplier for each item based on price, quality,
                and delivery terms.
              </Text>
                    ...
                    >
                      <Stack gap="md">
                                  ...
                                  {quote.hasQuote ? (
                                    <Text
                                      c={(() => {
                                        ...
                                        return quote.unitPrice === minPrice
                                          ? "green"
                                          : quote.unitPrice === maxPrice
                                          ? "red"
                                          : "dark";
                                      })()}
                                    >
                                ...
                                <Table.Td>
                                  {quote.hasQuote ? (
                                    <Text
                                      fw={600}
                                      c={(() => {
                                        const totals = supplierQuotes
                                          .filter((q) => q.hasQuote)
                                          .map((q) => q.total!);
                                        const minTotal = Math.min(...totals);
                                        const maxTotal = Math.max(...totals);
                                        return quote.total === minTotal
                                          ? "green"
                                          : quote.total === maxTotal
                                          ? "red"
                                          : "dark";
                                      })()}
                                    >
                        ...
                        {(() => {
                          ...
                          const lowestPriceSupplier = supplierQuotes
                            .filter((q) => q.hasQuote)
                            .reduce((min, quote) =>
                              quote.unitPrice! < min.unitPrice! ? quote : min
                            )?.supplier;
                          const isNotLowestPrice =
                            selectedSupplier &&
      ...
      >
        {viewingService &&
          (() => {
            ...
            const quotation = isAnalysis
              ? analysis.find((a) => a.id === quotationId)
            ...
            if (!service) {
              return (
                <Stack gap="md">
                  ...
                  <Text size="sm">
                    quotation found: {quotation ? "Yes" : "No"}
                  </Text>
                  <Text size="sm">
              ...
              <Stack gap="md">
                ...
                >
                  ...
                  {!service.name.includes("Flight") &&
                    ...
                    !service.name.includes("Car") && (
                      <Text size="sm" c="dimmed">
                        Service details not available for this type of service.
                      </Text>
                    )}
                </div>
              </Stack>
